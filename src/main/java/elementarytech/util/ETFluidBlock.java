...
public class ETFluidBlock extends BlockFluidClassic {
    ...
    public ETFluidBlock(Fluid fluid, Material material, String textureName1, String registryName1) {
	...
	public ETFluidBlock setFlammable(boolean flammable) 
	{
    ...
    public void registerBlockIcons(IIconRegister register) {
            stillIcon = register.registerIcon(ModInfo.MODID + ":" + textureName + "Still");
            flowingIcon = register.registerIcon(ModInfo.MODID + ":" + textureName + "Flowing");
    }
