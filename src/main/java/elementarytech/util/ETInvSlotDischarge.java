...
public class ETInvSlotDischarge extends InvSlot
{
    public int tier;
    public boolean allowRedstoneDust;

    public ETInvSlotDischarge(TileEntityInventory base, int oldStartIndex, InvSlot.Access access, int tier)
    {
        this(base, oldStartIndex, access, tier, InvSlot.InvSide.ANY);
    }

    public ETInvSlotDischarge(TileEntityInventory base, int oldStartIndex, InvSlot.Access access, int tier, InvSlot.InvSide preferredSide)
    {
        this(base, oldStartIndex, access, tier, true, preferredSide);
    }

    public ETInvSlotDischarge(TileEntityInventory base, int oldStartIndex, InvSlot.Access access, int tier, boolean allowRedstoneDust, InvSlot.InvSide preferredSide)
    {
