...
public class HandPump extends Item implements IElectricItem, IBoxable, IItemHudInfo {
    ...
    public HandPump() {
        ...
        this.maxCharge = ElementaryTech.config.handpumpMaxCharge;
        this.operationEUCost = ElementaryTech.config.handpumpOperationEUCost;
        this.tier = ElementaryTech.config.handpumpTier;
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":itemElectricHandpump");
    }
            ...
            if (inv[i] != null) {
                if (inv[i].getItem() instanceof ItemCell) {
                    if (inv[i].getItemDamage() == 0) {
                        if (ETUtils.addItemStackToInventory(player, cell)) {
