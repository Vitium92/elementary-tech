...
public class BronzeVatBlockRender implements ISimpleBlockRenderingHandler
{
    public static int renderId;

    public BronzeVatBlockRender()
    {
    ...
    {
        ETMachineBaseBlock blockmb = (ETMachineBaseBlock) block;
        ...
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        if (blockmb.getMachineType().equals(MachineType.SolarEvaporator))
            var11 = 0.5625f;
