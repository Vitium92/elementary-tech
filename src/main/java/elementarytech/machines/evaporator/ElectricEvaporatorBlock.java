...
public class ElectricEvaporatorBlock extends Block implements ITileEntityProvider {
    ...
    public ElectricEvaporatorBlock() {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister reg) {
        this.blockIcon = reg.registerIcon(ModInfo.MODID + ":electricEvaporatorFront");
        this.textureFrontActive = reg.registerIcon(ModInfo.MODID + ":electricEvaporatorFrontActive");
        this.textureSide = reg.registerIcon(ModInfo.MODID + ":electricEvaporatorSide");
        this.textureTop = reg.registerIcon(ModInfo.MODID + ":electricEvaporatorTop");
        this.textureBottom = reg.registerIcon(ModInfo.MODID + ":electricEvaporatorBottom");
    }
