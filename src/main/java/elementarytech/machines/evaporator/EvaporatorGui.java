...
public class EvaporatorGui extends GuiContainer {
    private static final ResourceLocation background = new ResourceLocation(ModInfo.MODID, "textures/gui/GUISolidFuelEvaporator.png");
    private EvaporatorContainer container;
    private String title = StatCollector.translateToLocal("elementarytech.gui.evaporator");
