...
public class ElectricEvaporatorGui extends GuiContainer {
    private static final ResourceLocation background = new ResourceLocation(ModInfo.MODID, "textures/gui/GUIElectricEvaporator.png");
    private ElectricEvaporatorContainer container;
    private String title = StatCollector.translateToLocal("elementarytech.gui.electricEvaporator");
